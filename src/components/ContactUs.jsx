  ...
  return (
    <div className="content-wrapper">
      <div className="image-container">
        <img className="aboutUsPic" src="B653ON.jpeg" alt="Lake Tahoe"></img>
      ...
      <div className="text">
        ...
        <p className="missionP">
          To ensure safety and preservation of the millions of lives that visit
          Lake Tahoe annually.
        </p>
        <p className="missionP">
        ...
        <p className="missionP">
          To accommodate local authorities and emergency response personnel the
          necessary resources in order to provide strategic guidance in
          enforcing safety measures.
        </p>
        <p className="missionP">
          To provide information to researchers to expedite data acquisition for
          acceleration in research.
        </p>
        <h2 className="missionTitle">Mission</h2>
        <p className="missionP">
          We collaborated with the UC Davis Tahoe Environmental Research Center
          to provide gratuitous access to web and mobile applications.
        </p>
        <p className="missionP">
        ...
        <p className="missionP">
          Utilized predictive hydrodynamic models to simulate future conditions
          of Lake Tahoe to shield the masses from hazardous natural occurrences.
        </p>
        ...
        <p className="missionP">
          Our ongoing commitment to excellence and knowledge enables meaningful
          engagement on local to global scales.
        </p>
        <p className="missionP">
